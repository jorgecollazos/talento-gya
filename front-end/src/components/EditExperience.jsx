                  ...
                  <form className="">
                    <div className="flex items-center space-x-9">
                      <input
                        placeholder="Cargo"
                        type="text"
                        defaultValue={experience.nombrecargo}
                    ...
                    <div className="flex items-center space-x-9 mt-4">
                      <input
                        ...
                        type="text"
                        defaultValue={experience.nombreempresa}
                        className="w-full focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200"
                      />
                    </div>
                    ...
                    <div className="flex items-center space-x-9 mt-4">
                      <input
                        ...
                        type="date"
                        defaultValue={experience.experienciafechainicio}
                      ...
                      <input
                        ...
                        type="date"
                        defaultValue={experience.experienciafechafinal}
                        className="w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200"
                      />
                      <input
                    ...
                    <div className="mt-4">
                      ...
                      >{experience.funcionesdesarrolladas}</textarea>
                      <textarea
                        ...
                        rows="2"
                        placeholder="Funciones"
                      >{experience.funcion2}</textarea>
                      <textarea
                        className="mt-4 form-control block w-full py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="exampleFormControlTextarea1"
                        rows="2"
                        placeholder="Funciones"
                      >{experience.funcion3}</textarea>
                      <textarea
