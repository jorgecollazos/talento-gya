...
export default function EditAcademicTraining( {academic} ) {
                  ...
                  <form className="">
                    ...
                    <div className="flex items-center space-x-9 mt-4">
                      <input
                        ...
                        name="primernombre"
                        defaultValue={academic.universidad}
                      />
                      <input
                        placeholder="Formación(carrera)"
                        className="w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200"
                        defaultValue={academic.carrerauniversitaria}
                      />
                    </div>
                    <div className="flex items-center space-x-9 mt-4">
                      <input
                        ...
                        type="date"
                        defaultValue={academic.inicioacademico}
                        className="w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200"
                      />
                      ...
                      <input
                        ...
                        type="date"
                        defaultValue={academic.finacademico}
                        className="w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200"
                      />
                    </div>
                    <div className="flex items-center space-x-9 mt-4">
                      <input
                        ...
                        type="date"
                        defaultValue={academic.fechaexpediciontitulo}
                        className="w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200"
                      />
                      <input
