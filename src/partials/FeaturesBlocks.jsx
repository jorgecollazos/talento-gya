      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-8 md:pb-16">
            <h2 className="h2 mb-4">¿Cómo funciona TalentoGyA+?</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Crea una cuenta</h4>
              <p className="text-gray-600 text-center">Inicia sesión con tu correo electrónico, cuenta de Google o Facebook.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Responde los formularios</h4>
              <p className="text-gray-600 text-center">Completa tus datos personales, formación académica, continua y experiencia laboral.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Gestiona tu CV</h4>
              <p className="text-gray-600 text-center">Edita tus datos, formación, experiencia y adjunta tus documentos.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Comparte y descarga</h4>
              <p className="text-gray-600 text-center">También descarga tus documentos.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Contrata</h4>
              <p className="text-gray-600 text-center">Postula a nuestras convocatorias.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Recibe constancias</h4>
              <p className="text-gray-600 text-center">Luego de la evaluación de desempeño.</p>
            </div>
